...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logoN.png" height="40px"></a>
            </div>
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="input-group" style="margin-bottom:10px;">
                        ...
                        <input class="form-control" id="date" name="date" value="<?php date_default_timezone_set("Asia/Dhaka"); echo date("Y-m-d") ?>" onchange="showUser(this.value)" />
                    </div>
    ...
    <div class="copyright-bar bg-black">
        <div class="container">
            <p class="pull-left small">&copy; All rights reserved. Designed By <a href="#">Md. Maidul Islam </a></p>
